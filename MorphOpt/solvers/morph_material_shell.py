...
class MorphMaterialShell(BaseSolver):
    ...
    def solve(self):
        ...
        fe = self.init_FEA(FE_inp,
                           shell_thickness=self.surface_params.thickness,
    ...
    @staticmethod
    def _solve_FEA(current_class: 'MorphMaterialShell', path_result,
                   pressure_list: list[float], shell_thickness: float,
                   shell_mu: float, shell_kappa: float, shell_density: float,
                   surface_names: list[str], mu: np.ndarray, kappa: np.ndarray,
